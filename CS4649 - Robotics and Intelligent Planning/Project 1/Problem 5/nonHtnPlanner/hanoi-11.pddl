(define (problem hanoi-11)
  ...
  (:init (smaller d1 p1) (smaller d2 p1) (smaller d3 p1) (smaller d4 p1) (smaller d5 p1) (smaller d6 p1) (smaller d7 p1) (smaller d8 p1) (smaller d9 p1) (smaller d10 p1) (smaller d11 p1)
        (smaller d1 p2) (smaller d2 p2) (smaller d3 p2) (smaller d4 p2) (smaller d5 p2) (smaller d6 p2) (smaller d7 p2) (smaller d8 p2) (smaller d9 p2) (smaller d10 p2) (smaller d11 p2)
        (smaller d1 p3) (smaller d2 p3) (smaller d3 p3) (smaller d4 p3) (smaller d5 p3) (smaller d6 p3) (smaller d7 p3) (smaller d8 p3) (smaller d9 p3) (smaller d10 p3) (smaller d11 p3)
