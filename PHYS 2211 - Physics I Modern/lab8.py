...
# Spacecraft
craft = sphere(pos=vector(-75520000,2752000,0), radius = 1e6, color=color.yellow)
vcraft = vector(421,2778,0)
...
print("Fnet = ", Fnet)
print("Parrallel: = ", mag(Fnet_tangent))
print("Tangent: = ", mag(Fnet_perp))
